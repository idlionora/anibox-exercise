...
export const trending = [
	{
		id: 137822,
		title: { romaji: 'Blue Lock', english: 'BLUELOCK' },
		...
		bannerImage:
			'https://s4.anilist.co/file/anilistcdn/media/anime/banner/137822-oevspckMGLuY.jpg',
		year: 2022,
	},
	{
		id: 139630,
	...
	},
	{
		...
		bannerImage:
			'https://s4.anilist.co/file/anilistcdn/media/anime/banner/146984-yAkTtW2AExVj.jpg',
		year: 2023,
	},
	{
		id: 142853,
		...
		bannerImage:
			'https://s4.anilist.co/file/anilistcdn/media/anime/banner/142853-65n3FTeSiyA6.jpg',
		year: 2023,
	},
	{
		id: 138565,
...
export const searchResult = [
	...
	{
		id: 131573,
		title: { romaji: 'Jujutsu Kaisen 0', english: 'JUJUTSU KAISEN 0' },
	...
	{
		id: 147463,
		title: { romaji: 'Jujutsu Kaisen PV', english: null },
		genres: ['Supernatural'],
		description:
			"PV1 (『呪術廻戦』公式PV　第一弾「虎杖」篇（c.v.中村悠一）) features Satoru Gojo's animation and manga panels, and explaining about series main character Yuji Itadori.\n<br><br>\nPV2 (『呪術廻戦』公式PV　第二弾「同級生」篇（c.v.中村悠一）) features Satoru Gojo's animation and manga panels, and explaining about series main characters Megumi Fushiguro and Nobara Kugisaki.\n<br><br>\nPV3 (『呪術廻戦』公式PV　第三弾「呪術高専」篇（c.v.中村悠一）) features Satoru Gojo's animation and manga panels, and explaining about series sorcerer school and curses.",
		format: 'ONA',
		coverImage:
			'https://s4.anilist.co/file/anilistcdn/media/anime/cover/medium/b147463-LmoLwL9DbYAn.jpg',
		bannerImage: null,
		year: null,
	},
	{
		id: 148515,
		title: { romaji: 'Bijutsu Kyouiku', english: 'The art education' },
		genres: ['Comedy', 'Romance'],
		description:
			'A graduation silent short film by Megumi Ishitani, depicting the conflict between two artists and their mentees.',
		format: 'MOVIE',
		coverImage:
			'https://s4.anilist.co/file/anilistcdn/media/anime/cover/medium/bx148515-vKI7wNTFDaFl.png',
		bannerImage: null,
		year: null,
	},
	{
		...
		bannerImage:
			'https://s4.anilist.co/file/anilistcdn/media/anime/banner/4654-YLc90XaeWvPb.jpg',
		year: 2008,
	},
	{
		id: 1072,
		title: { romaji: 'Sweat Punch', english: 'Sweat Punch' },
		genres: ['Action', 'Fantasy', 'Horror', 'Mecha', 'Music', 'Sci-Fi'],
		description:
			"Sweat Punch is a series of five Studio 4&deg;C shorts collected as a direct-to-DVD package film entitled <i>Deep Imagination</i>.<br><br>\n1. <b>Tanpetori Kyouju no Yuuutsu</b> (タンペトリー教授の憂鬱, Professor Dan Petory's Blues)<br>\nA musical number starring a hand puppet named Junior. The puppet is controlled by the drunken Professor Dan Petory who explains in puppetry the answers to such questions as why the Earth is blue and why UFOs fly in a zig-zag pattern.<br><br>\n2. <b>End of the World</b><br>\n\"End of the World\" is a science fiction story about a young alien girl named Yuko as she escapes from the world of humans. After meeting Kazumi, a human girl Yuko met at a rock concert, the girls head to Kazumi's apartment. Before Yuko even takes off her shoes, however, she leaves through Kazumi's TV with her trusty cybernetic steed FACE to wage a retaliatory campaign against hordes of S&amp;M monsters from another dimension, and the evil queen of Yuko's world.<br><br>\n3. <b>Kigeki</b> (喜劇, Comedy)<br>\nSet during the Irish War of Independence, a five-year old girl goes out in search of the mysterious Demon&rsquo;s Castle - home of the Black Knight whose services she hopes to recruit. The Black Knight is a dark, young, skilled swordsman who will only accept a particular genre of books as advance payment.<br><br>\n4. <b>Higan</b> (彼岸, Enlightenment)<br>\nAn injured man lies completely still in a hospital room with doctors hovering at his bedside, appearing serene and peaceful as he slowly succumbs to death. However, in his own mind, memories of a recent battle vividly flash by. Thoughts of death and chaos haunt him, even in his final moments.<br><br>\n5. <b>Garakuta no Machi</b> (ガラクタの町, Junk Town)<br>\nOne summer day, a young boy encounters a little robot at a shopping arcade-a hungry little robot, it turns out, as he devours one machine after the other, growing in size with each \"meal\". This story of a boy, a machine, and their little adventure is the tale of an unusual friendship, enriched by the details of daily life and seen through the director's unique visual style.<br><br>\n(Source: Studio 4&deg;C website)",
		format: 'OVA',
		coverImage:
			'https://s4.anilist.co/file/anilistcdn/media/anime/cover/medium/bx1072-3HZC9uQacKht.jpg',
		bannerImage: null,
		year: 2002,
	},
	{
		id: 100185,
		title: {
			romaji: 'Toaru Majutsu no Index III',
			english: 'A Certain Magical Index III',
		},
		genres: ['Action', 'Sci-Fi', 'Supernatural'],
		description:
